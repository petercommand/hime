...
enum {
  CHINESE_ENGLISH_TOGGLE_KEY_None =0,
  CHINESE_ENGLISH_TOGGLE_KEY_CapsLock =1,
  CHINESE_ENGLISH_TOGGLE_KEY_Tab =2,
  CHINESE_ENGLISH_TOGGLE_KEY_Shift =4,
  CHINESE_ENGLISH_TOGGLE_KEY_ShiftL =8,
  CHINESE_ENGLISH_TOGGLE_KEY_ShiftR =16,
};
