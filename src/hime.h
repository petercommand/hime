...
enum {
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_None=0,
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_CapsLock=1,
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_Tab=2,
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_Shift=4,
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_ShiftL=8,
  HIME_CHINESE_ENGLISH_TOGGLE_KEY_ShiftR=16,
};
